                      ...
                      <div className="w-full sm:w-1/2 sm:pr-8">
                        <div className="bg-white p-4 rounded shadow group hover:bg-primaryColor cursor-pointer easy-in duration-150">
                          ...
                          <p className="text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7">
                            ...
                            using React.js and demonstrated proficiency in
                            styling with Tailwind CSS. Implemented effective
                            filtering mechanisms to enhance user experience,
                            handling API calls and showcasing solid front-end
                            development skills.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="w-full sm:w-1/2 sm:pr-8">
                        <div className="bg-white p-4 rounded shadow group hover:bg-primaryColor cursor-pointer easy-in duration-150">
                          ...
                          <p className="text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7">
                            ...
                            resolving conflicts, ensuring smooth collaboration

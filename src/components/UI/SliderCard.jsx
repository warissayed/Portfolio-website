    ...
    <div className="w-full h-full flex items-center justify-center bg-white px-4 lg:px-10">
      <div className="w-full max-w-screen-lg flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border hover:bg-primaryColor hover:text-white  border-gray-300 text-smallTextColor  rounded-lg shadow-xl p-6 ">
            ...
            <ul className=" text-lg space-y-4">
              <li>
                ...
                <ul className="list-disc list-inside">
                  <li className=" text-sm     transition-all duration-200">

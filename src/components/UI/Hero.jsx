          ...
          <div className="w-ful md:basis-1/2 ">
            ...
            <RevealX>
              ...
              <p className="flex gap-2 text-headingColor mt-14 font-[600] text-[17px] leading-7 sm:pl-14 sm:pr-10">
                ...
                Crafting Exception Into Reality One Line at a Time: Where
                Passion Meets Proficiency, The Only Way to become a coding
                expert, You need to code, code, and code some more!
              </p>
            </RevealX>
            <Reveal>
              <motion.div
